...
@objc public protocol CollectionViewDelegateLayout: UICollectionViewDelegate{
...
public class CollectionViewLayout : UICollectionViewLayout{
    ...
    public weak var delegate : CollectionViewDelegateLayout?{
    get{
        return self.collectionView!.delegate as? CollectionViewDelegateLayout
    }
    }
